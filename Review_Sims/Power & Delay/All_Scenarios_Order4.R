...
x_underlying <- sin(2*pi*time/50) + cos(2*pi*time/20)  + sinh(-0.5+time/500) + cosh(-0.5+time/500)
...
for(j in 1:ncol(y)){
  ...
  fast_run <- fast(time, xfd, 4, yfd$fd[j], threshold = threshold)
