...
source("./Offline FAST/Offline_Partial_Period.R")
source("./Offline FAST/Offline_Full_Period.R")
...
write.csv(result_df_anomaly_at_start, "./Results/anomaly_at_start_results.csv")
...
write.csv(result_df_contaminated, "./Results/contaminated.csv")

write.csv(result_df_bic, "./Results/BIC_Consistency.csv")
write.csv(result_df_varying_m, "./Results/Varying_m.csv")

write.csv(result_df_offline_partial, "./Results/offline_partial.csv")
write.csv(result_df_offline_full, "./Results/offline_full.csv")
