...
result_df_varying_m_order1 <- result_df[-1,]
rownames(result_df_varying_m_order1) <- c("Model 1", "Model 2", "Model 3", "Model 4",
                                   "Model 5", "Model 6", "Model 7", "Model 8",
                                   "Model 9")
colnames(result_df_varying_m_order1) <- as.character(1:5)
print("Varying m Order 1 Sim: Done")
