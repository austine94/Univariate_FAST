...
The zip file contains three things.
	...
	3) A specific function, Build_Table9.R, to address the editorial comment regarding running the code for the comparative study.
Running each of these three elements will be described in turn below.

0) Package Requirements:
	These functions will require the R packages "fda", "fdaoutlier", "aplpack", "tidyverse", and "mvtnorm" are installed.
