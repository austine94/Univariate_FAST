...
write.csv(result_df_order1_comparison, "./Results/Table13.csv")
write.csv(result_df_order2_comparison, "./Results/Table6.csv")
...
write.csv(result_df_order1, "./Results/Table7.csv")
write.csv(result_df_order2, "./Results/Table1.csv")
write.csv(result_df_order3, "./Results/Table8.csv")
write.csv(result_df_order4, "./Results/Table9.csv")
write.csv(result_df_contaminated, "./Results/Table3.csv")

write.csv(result_df_varying_m_order1, "./Results/Table10.csv")
write.csv(result_df_varying_m_order2, "./Results/Table4.csv")
write.csv(result_df_varying_m_order3, "./Results/Table11.csv")
write.csv(result_df_varying_m_order4, "./Results/Table12.csv")
