...
for(j in 1:ncol(y)){
  ...
  fast_run <- fast_end_of_day(time, xfd, 1, yfd$fd[j], threshold = threshold)
...
result_df_order1_comparison <- result_df[-1,c(-4,-5)]
rownames(result_df_order1_comparison) <- c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6",
