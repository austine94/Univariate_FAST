...
result_df_partial_anomaly_sequential <- result_df[-1,c(-4,-5)]
rownames(result_df_partial_anomaly_sequential) <- c("Model 1", "Model 2", "Model 3", "Model 4", "Model 5", "Model 6",
                         "Model 7", "Model 8", "Model 9")
print("Review Reply Table 1 Sim: Done")